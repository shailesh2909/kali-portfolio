...
export class Window extends Component {
    ...
    changeCursorToDefault = () => {
        this.setState({ cursorType: "--app-cursor-default" })
    }
    ...
    return (
        <div className="absolute select-none right-0 top-0 mt-1 mr-1 flex justify-center items-center">
            <span className="mx-1.5 bg-white bg-opacity-0 hover:bg-opacity-10 rounded-full flex justify-center mt-1 h-5 w-5 items-center" onClick={props.minimize}>
                <img
                    src="./themes/Flat-Remix-Blue-Dark/window/window-minimize-symbolic.svg"
                    alt="kal window minimize"
            ...
            </span>
            {
                (props.isMaximised
                    ...
                    <span className="mx-2 bg-white bg-opacity-0 hover:bg-opacity-10 rounded-full flex justify-center mt-1 h-5 w-5 items-center" onClick={props.maximize}>
                        <img
                            src="./themes/Flat-Remix-Blue-Dark/window/window-restore-symbolic.svg"
                    ...
                    <span className="mx-2 bg-white bg-opacity-0 hover:bg-opacity-10 rounded-full flex justify-center mt-1 h-5 w-5 items-center" onClick={props.maximize}>
                        <img
                            src="./themes/Flat-Remix-Blue-Dark/window/window-maximize-symbolic.svg"
            ...
            <button tabIndex="-1" id={`close-${props.id}`} className="mx-1.5 focus:outline-none cursor-default bg-ub-blue bg-opacity-90 hover:bg-opacity-100 rounded-full flex justify-center mt-1 h-5 w-5 items-center" onClick={props.close}>
                <img
                    src="./themes/Flat-Remix-Blue-Dark/window/window-close-symbolic.svg"
