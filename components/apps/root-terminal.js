...
export class RootTerminal extends Component {
    constructor() {
        super();
        this.cursor = "";
...
export const displayRootTerminal = (addFolder, openApp) => {
    return <RootTerminal addFolder={addFolder} openApp={openApp}> </RootTerminal>;
}
