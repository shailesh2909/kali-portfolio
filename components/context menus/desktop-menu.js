...
function DesktopMenu(props) {
    ...
    return (
        <div id="desktop-menu" className={(props.active ? " block " : " hidden ") + " app-cursor-default w-52 context-menu-bg border text-left font-light border-gray-900 rounded text-white py-4 absolute z-50 text-sm"}>
